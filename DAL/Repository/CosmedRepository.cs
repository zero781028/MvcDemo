...
{
    public class CosmedRepository<TEntity> : ICosmedRepository<TEntity> where TEntity : class
    {
        internal COSMEDEntities context;
        internal DbSet<TEntity> dbSet;

        public CosmedRepository()
        {
            context = new COSMEDEntities();
